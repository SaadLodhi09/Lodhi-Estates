...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-8 pt-3 sm:pt-4 pb-2 pointer-events-none w-full max-w-[100vw]">
        <nav
          className={`max-w-[1300px] mx-auto w-full flex items-center justify-between px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-2xl pointer-events-auto transition-all duration-300 ${
            scrolled
        ...
        >
          ...
          <Link href="/" className="flex items-center gap-1.5 group flex-shrink-0">
            <span className="font-serif text-base sm:text-xl font-bold tracking-tight text-[#0A0A0A] group-hover:text-[#0F766E] transition">
              LODHI<span className="text-[#0F766E]">.</span><span className = "font-medium text-[#6B736B]">ESTATES</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="relative p-2 sm:p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 hover:text-slate-900 transition cursor-pointer"
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 md:hidden cursor-pointer"
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-white/95 backdrop-blur-3xl flex flex-col justify-center px-6 sm:px-8 text-[#0A0A0A] md:hidden">
          <div className="space-y-6">
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className="block font-serif text-2xl sm:text-3xl font-bold text-slate-900 hover:text-[#0F766E] transition"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="pt-8 mt-8 border-t border-slate-200">
            <button
              ...
              className="w-full py-4 bg-[#0F766E] text-white rounded-2xl font-bold text-xs uppercase tracking-wider shadow-lg"
            >
